...
export default function NourritureDetailAdmin() {
  ...
  async function addIngredient() {
    ...
    try {
      const { data, error } = await supabase
        .from("nourritures_ingredients")
        .insert([{ nourriture_id: id, ingredient_id: newIngredient.ingredient_id, quantite: newIngredient.quantite, unite: newIngredient.unite, alternatives: newIngredient.alternatives ? [newIngredient.alternatives] : [], type: newIngredient.type }])
        .select()
        .maybeSingle();
      if (error) throw error;
